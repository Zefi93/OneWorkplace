...
#    GroupTag = 'Karlberg - Test'
#    GroupTagOptions = 'Karlbergsgymnasiet','Karlberg - Test'
...
start "Start-OOBEDeploy" PowerShell -NoL -C Start-OOBEDeploy -UpdateDrivers -UpdateWindows
exit
'@
